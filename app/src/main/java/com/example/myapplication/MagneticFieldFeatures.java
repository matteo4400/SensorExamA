...
public class MagneticFieldFeatures extends AppCompatActivity {
    ...
    public void OpenDisplayMagneticFieldValue(View view) {
        Intent intent_sender = getIntent();
        final String index_to_send = intent_sender.getStringExtra(MagneticField.EXTRA_MESSAGE);
        Intent intent = new Intent(this, DisplayMagneticFieldValue.class);
