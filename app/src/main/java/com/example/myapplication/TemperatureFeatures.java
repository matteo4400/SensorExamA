...
public class TemperatureFeatures extends AppCompatActivity {
    ...
    public void OpenDisplayTemperatureValue(View view) {
        Intent intent_sender = getIntent();
        final String index_to_send = intent_sender.getStringExtra(AmbientTemperature.EXTRA_MESSAGE);
        Intent intent = new Intent(this, DisplayTemperatureValue.class);
